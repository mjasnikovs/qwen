...
OVERRIDE_TENSOR="${OVERRIDE_TENSOR:-blk\.(38|37|36|35)\.ffn_(gate|up|down)_exps\.=CUDA0,blk\.(34|33|31|30|29|28|27|26|25|23)\.ffn_(gate|up|down)_exps\.=CUDA1,blk\..*\.ffn_(gate|up|down)_exps\.=CPU}"
