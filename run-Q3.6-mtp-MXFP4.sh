...
OT_CUDA0='blk\.(4[0-9]|3[0-9]|2[0-9]|19)\.ffn_(gate|up|down)_exps\.=CUDA0'   # blk 19-40 -> 16 GB GPU
OT_CUDA1='blk\.(1[0-9]|[3-9])\.ffn_(gate|up|down)_exps\.=CUDA1'    # blk 3-18  -> 8 GB GPU
